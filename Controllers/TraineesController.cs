...
namespace MyFirst_CoreMVC.Controllers
{
    public class TraineesController : Controller
    {
        ...
        private readonly TietoevryContext _context;

        public TraineesController(ILogger<TraineesController> logger, IToastNotification toastNotification, TietoevryContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TietoevryContext.Trainees'  is null.");
            }
            var trainee = await _context.Trainees.FindAsync(id);
            if (trainee != null)
            {
